...
import sys
sys.path.append("/home/v-peihuamai/amlt-msra/unlearning/memit")
...
def get_tfidf_vectorizer(data_dir):
    """
...
if __name__ == "__main__":
   vec = get_tfidf_vectorizer("/home/v-peihuamai/amlt-msra/unlearning/data")